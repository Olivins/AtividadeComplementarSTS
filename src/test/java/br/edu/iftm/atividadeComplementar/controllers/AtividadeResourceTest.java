...
public class AtividadeResourceTest {
	...
	@Test
	public void test01GetSucesso() throws Exception{
	...
	@Test
	public void test02GetFalha() throws Exception{
	...
	@Test
	public void test03GetNomeSucesso() throws Exception{
	...
	@Test
	public void test04GetLikeFalha() throws Exception{
		String url = "/atividades/like/James";
		this.mvc.perform(get(url))
		.andExpect(status().isNotFound());
	}
	...
	public void test07SalvarSucesso() throws Exception{
		...
		.content("{\"codigo\": 5,\"nome\": \"Projeto X\", \"percentualCargaHoraria\": 10, \"maximoAtividadesSemestre\": 2, \"percentualPorAtividade\": 100}")
	...
	public void test08SalvarFalha() throws Exception{
		String url = "/atividades/";
		this.mvc.perform(post(url)
		.content("\"n0m3\": \"Curso de MVC\", \"percentualCargaHoraria\": 50, \"maximoAtividadesSemestre\": 1, \"percentualPorAtividade\": 100")
		.contentType(MediaType.APPLICATION_JSON))
	...
	public void teste11PutOk() throws Exception {
		...
		this.mvc.perform(put(url)
				.content("\"nome\": \"Curso de MVC\", \"percentualCargaHoraria\": 50, \"maximoAtividadesSemestre\": 1, \"percentualPorAtividade\": 100")
				.contentType(MediaType.APPLICATION_JSON))
